...
var initMarker = new mapboxgl.Marker()
        ...
        .addTo(map);
    currentMarkers.push(initMarker);
...
if(!document.getElementById('geocode').value){
    document.getElementById('geocode').value=campgroundLocation;
}
if(!document.getElementById('location').value){
    document.getElementById('location').value =campgroundPlace;
}